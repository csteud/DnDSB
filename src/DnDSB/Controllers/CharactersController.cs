...
namespace DnDSB.Controllers
{
    public class CharactersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CharacterId,CharacterName,Hp,Str,Dex,Con,Int,Wis,Cha")] Character character)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CharacterId,CharacterName,Hp,Str,Dex,Con,Int,Wis,Cha")] Character character)
        {
